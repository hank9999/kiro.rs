...
import { ProxyPoolManager } from '@/components/proxy-pool-manager'
...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'credentials' | 'proxy-pool'>('credentials')
